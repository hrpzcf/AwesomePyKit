...
class Ui_PyInstallerTool(object):
    def setupUi(self, PyInstallerTool):
        ...
        PyInstallerTool.resize(951, 759)
        font = QtGui.QFont()
        ...
        self.horizontalLayout_4.addWidget(self.le_project_root)
        self.pb_select_project_root = QtWidgets.QPushButton(self.tab_project_files)
        self.pb_select_project_root.setObjectName("pb_select_project_root")
        self.horizontalLayout_4.addWidget(self.pb_select_project_root)
        ...
        self.le_program_entry = QtWidgets.QLineEdit(self.tab_project_files)
        self.le_program_entry.setObjectName("le_program_entry")
        self.horizontalLayout_3.addWidget(self.le_program_entry)
        ...
        self.te_module_search_path = QtWidgets.QTextEdit(self.tab_project_files)
        self.te_module_search_path.setContextMenuPolicy(QtCore.Qt.NoContextMenu)
        self.te_module_search_path.setObjectName("te_module_search_path")
        self.verticalLayout_3.addWidget(self.te_module_search_path)
        ...
        self.te_other_data = QtWidgets.QTextEdit(self.tab_project_files)
        self.te_other_data.setContextMenuPolicy(QtCore.Qt.NoContextMenu)
        self.te_other_data.setObjectName("te_other_data")
        self.verticalLayout_4.addWidget(self.te_other_data)
        ...
        self.le_file_icon_path = QtWidgets.QLineEdit(self.tab_project_files)
        self.le_file_icon_path.setObjectName("le_file_icon_path")
        self.horizontalLayout_11.addWidget(self.le_file_icon_path)
        ...
        self.verticalLayout_16 = QtWidgets.QVBoxLayout(self.tab_build_control)
        self.verticalLayout_16.setObjectName("verticalLayout_16")
        self.verticalLayout_15 = QtWidgets.QVBoxLayout()
        self.verticalLayout_15.setObjectName("verticalLayout_15")
        self.horizontalLayout_9 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_9.setObjectName("horizontalLayout_9")
        self.rb_pack_single_folder = QtWidgets.QRadioButton(self.tab_build_control)
        self.rb_pack_single_folder.setObjectName("rb_pack_single_folder")
        self.horizontalLayout_9.addWidget(self.rb_pack_single_folder)
        self.rb_pack_single_file = QtWidgets.QRadioButton(self.tab_build_control)
        self.rb_pack_single_file.setObjectName("rb_pack_single_file")
        self.horizontalLayout_9.addWidget(self.rb_pack_single_file)
        self.verticalLayout_15.addLayout(self.horizontalLayout_9)
        self.cb_executeable_with_console = QtWidgets.QCheckBox(self.tab_build_control)
        self.cb_executeable_with_console.setObjectName("cb_executeable_with_console")
        self.verticalLayout_15.addWidget(self.cb_executeable_with_console)
        self.cb_clear_dir_without_confirm = QtWidgets.QCheckBox(self.tab_build_control)
        self.cb_clear_dir_without_confirm.setObjectName("cb_clear_dir_without_confirm")
        self.verticalLayout_15.addWidget(self.cb_clear_dir_without_confirm)
        self.cb_use_upx = QtWidgets.QCheckBox(self.tab_build_control)
        self.cb_use_upx.setObjectName("cb_use_upx")
        self.verticalLayout_15.addWidget(self.cb_use_upx)
        self.cb_clean_cache_before_build = QtWidgets.QCheckBox(self.tab_build_control)
        self.cb_clean_cache_before_build.setObjectName("cb_clean_cache_before_build")
        self.verticalLayout_15.addWidget(self.cb_clean_cache_before_build)
        ...
        self.te_version_file = QtWidgets.QTextEdit(self.tab_build_control)
        self.te_version_file.setObjectName("te_version_file")
        self.verticalLayout_12.addWidget(self.te_version_file)
        ...
        self.le_pyi_info = QtWidgets.QLineEdit(self.centralwidget)
        self.le_pyi_info.setFrame(False)
        self.le_pyi_info.setReadOnly(True)
        self.le_pyi_info.setObjectName("le_pyi_info")
        self.horizontalLayout.addWidget(self.le_pyi_info)
        ...
        self.le_py_info = QtWidgets.QLineEdit(self.centralwidget)
        self.le_py_info.setFrame(False)
        self.le_py_info.setReadOnly(True)
        self.le_py_info.setObjectName("le_py_info")
        self.horizontalLayout_2.addWidget(self.le_py_info)
        self.pb_select_py_env = QtWidgets.QPushButton(self.centralwidget)
        self.pb_select_py_env.setObjectName("pb_select_py_env")
        self.horizontalLayout_2.addWidget(self.pb_select_py_env)
        self.horizontalLayout_2.setStretch(0, 9)
        self.verticalLayout_18.addLayout(self.horizontalLayout_2)
        self.le_platform_info = QtWidgets.QLineEdit(self.centralwidget)
        self.le_platform_info.setFrame(False)
        self.le_platform_info.setReadOnly(True)
        self.le_platform_info.setObjectName("le_platform_info")
        self.verticalLayout_18.addWidget(self.le_platform_info)
        ...
        self.le_outfile_spec_name = QtWidgets.QLineEdit(self.centralwidget)
        self.le_outfile_spec_name.setObjectName("le_outfile_spec_name")
        self.verticalLayout_19.addWidget(self.le_outfile_spec_name)
        ...
        self.te_pyi_outstream = QtWidgets.QTextEdit(self.centralwidget)
        self.te_pyi_outstream.setMinimumSize(QtCore.QSize(0, 456))
        self.te_pyi_outstream.setContextMenuPolicy(QtCore.Qt.PreventContextMenu)
        self.te_pyi_outstream.setReadOnly(True)
        self.te_pyi_outstream.setObjectName("te_pyi_outstream")
        self.verticalLayout_21.addWidget(self.te_pyi_outstream)
    ...
    def retranslateUi(self, PyInstallerTool):
        ...
        self.pb_select_project_root.setText(_translate("PyInstallerTool", "选择目录"))
        self.label.setText(_translate("PyInstallerTool", "程序主模块："))
        self.pb_select_program_entry.setText(_translate("PyInstallerTool", "选择文件"))
        ...
        self.pb_select_module_search_path.setText(_translate("PyInstallerTool", "选择文件"))
        self.label_4.setText(_translate("PyInstallerTool", "非源代码资源文件："))
        self.pb_clear_other_data.setText(_translate("PyInstallerTool", "清空"))
        self.pb_select_other_data.setText(_translate("PyInstallerTool", "选择文件"))
        self.label_7.setText(_translate("PyInstallerTool", "文件图标路径："))
        self.pb_select_file_icon.setText(_translate("PyInstallerTool", "选择文件"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_project_files), _translate("PyInstallerTool", "项目文件"))
        self.rb_pack_single_folder.setText(_translate("PyInstallerTool", "打包成单目录（建议）"))
        self.rb_pack_single_file.setText(_translate("PyInstallerTool", "打包成单文件"))
        self.cb_executeable_with_console.setText(_translate("PyInstallerTool", "打包的程序运行时显示控制台"))
        self.cb_clear_dir_without_confirm.setText(_translate("PyInstallerTool", "输出目录不为空时清空而无需确认"))
        self.cb_use_upx.setText(_translate("PyInstallerTool", "使用UPX对文件进行压缩"))
        self.cb_clean_cache_before_build.setText(_translate("PyInstallerTool", "构建前清理缓存并删除临时文件"))
        self.label_11.setText(_translate("PyInstallerTool", "字节码加密秘钥："))
        self.label_10.setText(_translate("PyInstallerTool", "临时工作目录："))
        self.le_temp_working_dir.setPlaceholderText(_translate("PyInstallerTool", "./build"))
        self.pb_select_temp_working_dir.setText(_translate("PyInstallerTool", "选择"))
        self.label_8.setText(_translate("PyInstallerTool", "目标输出目录："))
        self.le_output_dir.setPlaceholderText(_translate("PyInstallerTool", "./dist"))
        self.pb_select_output_dir.setText(_translate("PyInstallerTool", "选择"))
        self.label_9.setText(_translate("PyInstallerTool", "UPX可执行文件搜索路径："))
        ...
        self.label_12.setText(_translate("PyInstallerTool", "文件版本信息："))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_build_control), _translate("PyInstallerTool", "生成控制"))
        self.label_6.setText(_translate("PyInstallerTool", "Pyi版本："))
        self.label_16.setText(_translate("PyInstallerTool", "Python版本："))
        self.label_15.setText(_translate("PyInstallerTool", "系统信息："))
        self.le_pyi_info.setText(_translate("PyInstallerTool", "Pyinstaller 4.1"))
        self.pushButton.setText(_translate("PyInstallerTool", "重新安装"))
        self.le_py_info.setText(_translate("PyInstallerTool", "Python 3.8.7 32bit"))
        self.pb_select_py_env.setText(_translate("PyInstallerTool", "选择环境"))
        self.le_platform_info.setText(_translate("PyInstallerTool", "Windows-10-10.0.19041-SP0"))
        self.label_13.setText(_translate("PyInstallerTool", "可执行文件和规范文件名称："))
        self.label_5.setText(_translate("PyInstallerTool", "输出息流："))
