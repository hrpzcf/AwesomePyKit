...
class Ui_PyInstallerTool(object):
    def setupUi(self, PyInstallerTool):
        ...
        PyInstallerTool.resize(880, 769)
        font = QtGui.QFont()
        ...
        self.le_project_root_old = QtWidgets.QLineEdit(self.tab_project_files)
        self.le_project_root_old.setContextMenuPolicy(QtCore.Qt.NoContextMenu)
        self.le_project_root_old.setObjectName("le_project_root_old")
        self.horizontalLayout_4.addWidget(self.le_project_root_old)
        ...
        self.le_version_file_old = QtWidgets.QLineEdit(self.tab_build_control)
        self.le_version_file_old.setContextMenuPolicy(QtCore.Qt.NoContextMenu)
        self.le_version_file_old.setObjectName("le_version_file_old")
        self.horizontalLayout_10.addWidget(self.le_version_file_old)
        self.pb_version_file = QtWidgets.QPushButton(self.tab_build_control)
        self.pb_version_file.setObjectName("pb_version_file")
        self.horizontalLayout_10.addWidget(self.pb_version_file)
        ...
        self.le_py_info.setContextMenuPolicy(QtCore.Qt.NoContextMenu)
        ...
        self.horizontalLayout.addWidget(self.le_py_info)
        ...
        self.le_pyi_info.setContextMenuPolicy(QtCore.Qt.NoContextMenu)
        ...
        self.horizontalLayout_2.addWidget(self.le_pyi_info)
        ...
        self.le_platform_info.setContextMenuPolicy(QtCore.Qt.NoContextMenu)
        self.le_platform_info.setText("")
        ...
        self.te_pyi_outstream_old = QtWidgets.QTextEdit(self.centralwidget)
        self.te_pyi_outstream_old.setMinimumSize(QtCore.QSize(0, 456))
        self.te_pyi_outstream_old.setContextMenuPolicy(QtCore.Qt.NoContextMenu)
        self.te_pyi_outstream_old.setReadOnly(True)
        self.te_pyi_outstream_old.setObjectName("te_pyi_outstream_old")
        self.verticalLayout_16.addWidget(self.te_pyi_outstream_old)
    ...
    def retranslateUi(self, PyInstallerTool):
        ...
        self.label_8.setText(_translate("PyInstallerTool", "储存生成文件位置："))
        ...
        self.label_17.setText(_translate("PyInstallerTool", "储存SPEC文件位置："))
        self.le_spec_dir.setPlaceholderText(_translate("PyInstallerTool", "./"))
        ...
        self.pb_version_file.setText(_translate("PyInstallerTool", "选择"))
