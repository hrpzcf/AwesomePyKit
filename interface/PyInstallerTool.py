...
class Ui_PyInstallerTool(object):
    ...
    def retranslateUi(self, PyInstallerTool):
        ...
        self.le_exefile_specfile_name.setPlaceholderText(_translate("PyInstallerTool", "留空则使用主模块名称"))
        ...
        self.le_project_root.setPlaceholderText(_translate("PyInstallerTool", "选择主程序后自动确定"))
