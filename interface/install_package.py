...
class Ui_install_package(object):
    ...
    def retranslateUi(self, install_package):
        ...
        self.label_3.setToolTip(_translate("install_package", "当前即将安装的包的目标环境。"))
        self.label_3.setText(_translate("install_package", "目标环境："))
        self.le_target_env.setToolTip(_translate("install_package", "当前即将安装的包的目标环境。"))
        self.label.setText(_translate("install_package", "名称："))
        self.cb_including_pre.setToolTip(_translate("install_package", "从网络安装时是否查找包括预发行版和开发版在内的版本。\n"
"如果预发行版或开发版是最新版本，则安装预发行版或开发版。"))
        self.cb_including_pre.setText(_translate("install_package", "包括预发行版和开发版"))
        self.cb_install_for_user.setToolTip(_translate("install_package", "将包安装到系统当前登录的用户的用户目录内。"))
        self.cb_install_for_user.setText(_translate("install_package", "仅为当前用户安装"))
        self.pb_load_from_text.setToolTip(_translate("install_package", "从文本文件载入名称及版本等内容。\n"
"例如从常见的requirements.txt文件载入。"))
        self.pb_load_from_text.setText(_translate("install_package", "从文件加载名称"))
        self.pb_save_as_text.setToolTip(_translate("install_package", "将文本框内的内容保存至文本文件。"))
