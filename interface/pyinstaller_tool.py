...
class Ui_pyinstaller_tool(object):
    def setupUi(self, pyinstaller_tool):
        ...
        self.horizontalLayout_19.addWidget(self.splitter)
...
"选择不同PYTHON环境时，在该环境中也应安装运行项目所需的所有模块。"))
        self.label_6.setText(_translate("pyinstaller_tool", "Py信息："))
...
"选择不同PYTHON环境时，在该环境中也应安装运行项目所需的所有模块。"))
        ...
        self.pb_check_imports.setToolTip(_translate("pyinstaller_tool", "检测程序运行所需的所有模块是否在已选的PYTHON环境中安装(测试)。"))
