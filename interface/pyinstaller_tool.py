...
class Ui_pyinstaller_tool(object):
    def setupUi(self, pyinstaller_tool):
        ...
        pyinstaller_tool.resize(870, 739)
        font = QtGui.QFont()
        ...
        self.lb_pyi_info = QtWidgets.QLabel(self.widget)
        ...
        self.pb_reinstall_pyi = QtWidgets.QPushButton(self.widget)
        ...
        self.lb_py_info = QtWidgets.QLabel(self.widget)
        ...
        self.pb_select_py_env = QtWidgets.QPushButton(self.widget)
        ...
        self.lb_platform_info = QtWidgets.QLabel(self.widget)
        ...
        self.cb_prioritize_use_virtualenv = QtWidgets.QCheckBox(self.widget)
        self.cb_prioritize_use_virtualenv.setObjectName("cb_prioritize_use_virtualenv")
        self.gridLayout_2.addWidget(self.cb_prioritize_use_virtualenv, 3, 1, 1, 1)
        ...
        self.cb_log_level = QtWidgets.QComboBox(self.widget)
        ...
        self.te_pyi_out_stream = QtWidgets.QTextEdit(self.widget)
        ...
        self.lb_running_gif = QtWidgets.QLabel(self.widget)
        ...
        self.lb_running_tip = QtWidgets.QLabel(self.widget)
        ...
        self.pb_check_imports = QtWidgets.QPushButton(self.widget)
        ...
        self.pb_gen_executable = QtWidgets.QPushButton(self.widget)
    ...
    def retranslateUi(self, pyinstaller_tool):
        ...
        self.label.setToolTip(_translate("pyinstaller_tool", "要打包的程序的启动入口脚本(*.py *.pyw *.pyc *.spec)，此项必填。\n"
"如果指定了SPEC文件，则以下绝大部分项目文件及生成控制都将不生效。"))
        self.label.setText(_translate("pyinstaller_tool", "主程序："))
        self.le_program_entry_old.setToolTip(_translate("pyinstaller_tool", "要打包的程序的启动入口脚本(*.py *.pyw *.pyc *.spec)，此项必填。\n"
"如果指定了SPEC文件，则以下绝大部分项目文件及生成控制都将不生效。"))
        self.pb_select_program_entry.setText(_translate("pyinstaller_tool", "选择"))
        self.label_13.setToolTip(_translate("pyinstaller_tool", "打包完成后的exe可执行文件文件的名称，此项留空则使用主程序文件名。"))
        self.label_13.setText(_translate("pyinstaller_tool", "生成文件名称："))
        self.le_exefile_specfile_name.setToolTip(_translate("pyinstaller_tool", "打包完成后的exe可执行文件文件的名称，此项留空则使用主程序文件名。"))
        self.label_2.setToolTip(_translate("pyinstaller_tool", "当前的项目根目录，选择主程序文件后自动确定。"))
        self.label_2.setText(_translate("pyinstaller_tool", "项目根目录："))
        self.pb_reset_root_level.setToolTip(_translate("pyinstaller_tool", "将项目根目录重置为主程序所在目录。"))
        ...
        self.le_project_root.setToolTip(_translate("pyinstaller_tool", "当前的项目根目录，选择主程序文件后自动确定。"))
        self.label_3.setToolTip(_translate("pyinstaller_tool", "程序的其他模块的搜索目录(仅当PYINSTALLER无法自动找到时使用)。"))
        self.label_3.setText(_translate("pyinstaller_tool", "其他模块搜索路径："))
        ...
        self.label_4.setToolTip(_translate("pyinstaller_tool", "非源代码性质的其他资源文件，例如一些图片、配置文件等。"))
        ...
        self.label_7.setToolTip(_translate("pyinstaller_tool", "生成的exe可执行文件的图标，支持.ico、.icns图标文件。"))
        self.label_7.setText(_translate("pyinstaller_tool", "文件图标路径："))
        self.le_file_icon_path_old.setToolTip(_translate("pyinstaller_tool", "生成的exe可执行文件的图标，支持.ico、.icns图标文件。"))
        ...
        self.rb_pack_to_one_dir.setToolTip(_translate("pyinstaller_tool", "将程序打包成单文件夹形式，exe可执行程序在文件夹的首层目录内。"))
        self.rb_pack_to_one_dir.setText(_translate("pyinstaller_tool", "打包成单目录(推荐)"))
        self.rb_pack_to_one_file.setToolTip(_translate("pyinstaller_tool", "将程序以及添加的其他资源文件打包成单一文件的形式，启动速度较慢。"))
        self.rb_pack_to_one_file.setText(_translate("pyinstaller_tool", "打包成单文件"))
        self.cb_execute_with_console.setToolTip(_translate("pyinstaller_tool", "打包完成后启动程序是否显示命令行窗口，注意，后缀为pyw的主程序打包后不显示控制台，此项设置失效。"))
        self.cb_execute_with_console.setText(_translate("pyinstaller_tool", "打包的程序运行时显示控制台"))
        self.cb_without_confirm.setToolTip(_translate("pyinstaller_tool", "当要储存生成的exe可执行文件的文件夹不为空时，是否清空该文件夹。"))
        self.cb_without_confirm.setText(_translate("pyinstaller_tool", "输出目录不为空时清空而不是中断"))
        self.cb_use_upx.setToolTip(_translate("pyinstaller_tool", "打包过程中是否使用upx对文件进行压缩。\n"
"注意，某些二进制文件在经过upx压缩后可能无法正常运行。\n"
"仅当系统环境变量PATH中有upx路径信息或在以下“upx可执行文件查找路径”指定了upx查找路径时，此项设置才生效。"))
        self.cb_use_upx.setText(_translate("pyinstaller_tool", "使用UPX对文件进行压缩"))
        self.cb_clean_before_build.setToolTip(_translate("pyinstaller_tool", "生成exe可执行文件前是否清空PYINSTALLER生成的临时文件夹(临时文件可用于下次加速生成)。"))
        self.cb_clean_before_build.setText(_translate("pyinstaller_tool", "构建前清理缓存并删除临时文件"))
        self.cb_write_info_to_exec.setToolTip(_translate("pyinstaller_tool", "勾选此选项则将\"附加信息\"标签页中的条目写入生成的exe文件。"))
        self.cb_write_info_to_exec.setText(_translate("pyinstaller_tool", "将附加信息写入生成的可执行文件"))
        self.label_11.setToolTip(_translate("pyinstaller_tool", "用于加密打包过程中生成PYC文件时的加密，此项可留空。"))
        self.label_11.setText(_translate("pyinstaller_tool", "字节码加密秘钥："))
        self.le_bytecode_encryption_key.setToolTip(_translate("pyinstaller_tool", "用于加密打包过程中生成PYC文件时的加密，此项可留空。"))
        self.label_8.setToolTip(_translate("pyinstaller_tool", "此项可留空，默认储存位置：\"项目根目录/DIST\"。"))
        self.label_8.setText(_translate("pyinstaller_tool", "生成文件储存位置："))
        self.le_output_dir.setToolTip(_translate("pyinstaller_tool", "此项可留空，默认储存位置：\"项目根目录/DIST\"。"))
        self.pb_select_output_dir.setText(_translate("pyinstaller_tool", "选择"))
        self.label_17.setToolTip(_translate("pyinstaller_tool", "此项可留空，默认储存位置：\"项目根目录\"。"))
        self.label_17.setText(_translate("pyinstaller_tool", "SPEC文件储存位置："))
        self.le_spec_dir.setToolTip(_translate("pyinstaller_tool", "此项可留空，默认储存位置：\"项目根目录\"。"))
        self.pb_select_spec_dir.setText(_translate("pyinstaller_tool", "选择"))
        self.label_10.setToolTip(_translate("pyinstaller_tool", "此项可留空，默认目录：\"项目根目录/BUILD\"。"))
        self.label_10.setText(_translate("pyinstaller_tool", "临时文件目录："))
        self.le_temp_working_dir.setToolTip(_translate("pyinstaller_tool", "此项可留空，默认目录：\"项目根目录/BUILD\"。"))
        self.pb_select_temp_working_dir.setText(_translate("pyinstaller_tool", "选择"))
        self.label_9.setToolTip(_translate("pyinstaller_tool", "UPX.EXE文件所在目录。\n"
"此项可留空，找不到UPX时将不进行压缩。\n"
"当系统环境变量PATH中有UPX路径时，此项不需要指定也可使用UPX。"))
        self.label_9.setText(_translate("pyinstaller_tool", "UPX可执行文件查找路径："))
        self.le_upx_search_path.setToolTip(_translate("pyinstaller_tool", "UPX.EXE文件所在目录。\n"
"此项可留空，找不到UPX时将不进行压缩。\n"
"当系统环境变量PATH中有UPX路径时，此项不需要指定也可使用UPX。"))
        self.pb_select_upx_search_path.setText(_translate("pyinstaller_tool", "选择"))
        self.label_14.setToolTip(_translate("pyinstaller_tool", "使用UPX进行压缩时需要忽略的文件，每行一个文件名。\n"
"某些动态链接库或可执行文件经过UPX压缩后可能无法运行，可将这些文件名添加到此处以使UPX在压缩时略过。"))
        self.label_14.setText(_translate("pyinstaller_tool", "UPX压缩时排除的文件名："))
        self.te_upx_exclude_files.setToolTip(_translate("pyinstaller_tool", "使用UPX进行压缩时需要忽略的文件，每行一个文件名。\n"
"某些动态链接库或可执行文件经过UPX压缩后可能无法运行，可将这些文件名添加到此处以使UPX在压缩时略过。"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_build_control), _translate("pyinstaller_tool", "生成控制"))
...
"生成的可执行文件的附加信息，即鼠标悬停于exe文件上显示的信息，以及exe文件属性中的详细信息。"))
        ...
        self.cb_db_imports.setToolTip(_translate("pyinstaller_tool", "每次初始化模块时，打印一条消息，显示加载该模块的位置(文件名或内置模块)。\n"
"要求源代码文件后缀名不能是 *.pyw，\"生成控制\"标签中的\"打包的程序运行时显示控制台\"选项必须勾选。"))
        self.cb_db_imports.setText(_translate("pyinstaller_tool", "运行时输出模块导入信息"))
        self.cb_db_bootloader.setToolTip(_translate("pyinstaller_tool", "使引导程序在初始化和启动捆绑的应用程序时发出进度消息，用于诊断导入丢失的问题。\n"
"要求源代码文件后缀名不能是 *.pyw，\"生成控制\"标签中的\"打包的程序运行时显示控制台\"选项必须勾选。"))
        self.cb_db_bootloader.setText(_translate("pyinstaller_tool", "运行时输出引导进度信息"))
        self.cb_db_noarchive.setToolTip(_translate("pyinstaller_tool", "不将所有冻结的源代码文件存档在生成的可执行文件中，而是将它们作为单独的文件存储在生成的输出目录中。"))
        self.cb_db_noarchive.setText(_translate("pyinstaller_tool", "不将源文件存档至可执行文件中"))
        self.groupBox_2.setToolTip(_translate("pyinstaller_tool", "以\"单文件\"模式打包的程序运行时提取的库和支持文件的临时储存位置。\n"
...
"\"_MEIxxxxxx\"文件夹将在您指定的位置创建，仅当您知道自己在做什么时，才使用此选项。"))
        ...
        self.label_16.setToolTip(_translate("pyinstaller_tool", "所选PYTHON环境下的PYINSTALLER的版本信息。"))
        self.label_16.setText(_translate("pyinstaller_tool", "Pyi版本"))
        self.lb_pyi_info.setToolTip(_translate("pyinstaller_tool", "所选PYTHON环境下的PYINSTALLER的版本信息。"))
        self.pb_reinstall_pyi.setToolTip(_translate("pyinstaller_tool", "在当前选择的PYTHON环境中安装或重新安装PYINSTALLER。"))
        self.pb_reinstall_pyi.setText(_translate("pyinstaller_tool", "安装"))
        self.label_6.setToolTip(_translate("pyinstaller_tool", "选择在不同PYTHON环境中将程序打包成可执行文件。\n"
"如果可选条目为空，需要先在\"包管理器\"中添加本机PYTHON环境。\n"
"选择不同PYTHON环境时，在该环境中也应安装运行项目所需的所有模块。"))
        self.label_6.setText(_translate("pyinstaller_tool", "Py版本"))
        self.lb_py_info.setToolTip(_translate("pyinstaller_tool", "当前选择的PYTHON环境的版本信息。\n"
"选择不同Python环境时，在该环境中也应安装运行项目所需的所有模块。"))
        self.pb_select_py_env.setToolTip(_translate("pyinstaller_tool", "选择在不同PYTHON环境中将程序打包成可执行文件。\n"
"如果可选条目为空，需要先在\"包管理器\"中添加本机PYTHON环境。\n"
"选择不同PYTHON环境时，在该环境中也应安装运行项目所需的所有模块。"))
        self.pb_select_py_env.setText(_translate("pyinstaller_tool", "选择环境"))
        self.label_15.setToolTip(_translate("pyinstaller_tool", "操作系统的版本信息。"))
        self.label_15.setText(_translate("pyinstaller_tool", "系统版本"))
        self.lb_platform_info.setToolTip(_translate("pyinstaller_tool", "操作系统的版本信息。"))
        self.cb_prioritize_use_virtualenv.setText(_translate("pyinstaller_tool", "优先使用项目目录下的 Python 虚拟环境"))
        self.label_5.setToolTip(_translate("pyinstaller_tool", "打包时输出的流程信息，包含一些用于分析打包问题的信息。"))
        self.label_5.setText(_translate("pyinstaller_tool", "日志信息"))
        self.label_18.setToolTip(_translate("pyinstaller_tool", "打包程序时输出的流程信息的详细程度，越靠前越详细，默认INFO。"))
        self.label_18.setText(_translate("pyinstaller_tool", "级别："))
        self.cb_log_level.setToolTip(_translate("pyinstaller_tool", "打包程序时输出的流程信息的详细程度，越靠前越详细，默认INFO。"))
        ...
        self.pb_check_imports.setToolTip(_translate("pyinstaller_tool", "检测程序运行所需的所有模块是否在已选的PYTHON环境中安装。"))
        self.pb_check_imports.setText(_translate("pyinstaller_tool", "模块检测"))
        self.pb_gen_executable.setToolTip(_translate("pyinstaller_tool", "将PY脚本及所选资源文件打包成可执行文件。"))
        self.pb_gen_executable.setText(_translate("pyinstaller_tool", "生成可执行文件"))
