...
class Ui_imports_check(object):
    def setupUi(self, imports_check):
        ...
        imports_check.setWindowModality(QtCore.Qt.ApplicationModal)
        imports_check.resize(900, 566)
        font = QtGui.QFont()
        ...
        self.label = QtWidgets.QLabel(imports_check)
        self.label.setObjectName("label")
        self.horizontalLayout_2.addWidget(self.label)
        self.le_cip_cur_env = QtWidgets.QLineEdit(imports_check)
        ...
        self.tw_missing_imports = QtWidgets.QTableWidget(imports_check)
        ...
        self.pb_install_all_missing = QtWidgets.QPushButton(imports_check)
        ...
        self.pb_confirm = QtWidgets.QPushButton(imports_check)
    ...
    def retranslateUi(self, imports_check):
        ...
        imports_check.setWindowTitle(_translate("imports_check", "导入项检查"))
