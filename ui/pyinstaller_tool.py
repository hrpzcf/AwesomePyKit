...
class Ui_pyinstaller_tool(object):
    def setupUi(self, pyinstaller_tool):
        ...
        self.uiPushButton_save_cur_config = QtWidgets.QPushButton(self.groupBox_4)
        self.uiPushButton_save_cur_config.setObjectName("uiPushButton_save_cur_config")
        self.horizontalLayout_32.addWidget(self.uiPushButton_save_cur_config)
...
"输入一个你容易记住的备注名称并点击“保存”按钮将这些设置保存下来以便在不同的打包项目之间快速切换。"))
        ...
        self.uiPushButton_save_cur_config.setToolTip(_translate("pyinstaller_tool", "将“程序打包工具”当前复选框、输入框等控件设置状态保存下来，以左侧输入框内容作为这个保存下来的配置的名称。"))
        self.uiPushButton_save_cur_config.setText(_translate("pyinstaller_tool", "保存"))
