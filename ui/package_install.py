...
class Ui_package_install(object):
    def setupUi(self, package_install):
        ...
        package_install.resize(480, 486)
        package_install.setMinimumSize(QtCore.QSize(480, 486))
        package_install.setMaximumSize(QtCore.QSize(480, 486))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(9)
        package_install.setFont(font)
        self.verticalLayout_7 = QtWidgets.QVBoxLayout(package_install)
        ...
        self.le_target_env = QtWidgets.QLineEdit(package_install)
        ...
        self.splitter = QtWidgets.QSplitter(package_install)
    ...
    def retranslateUi(self, package_install):
        ...
        self.le_target_env.setToolTip(_translate("package_install", "当前即将安装的包的目标环境。"))
