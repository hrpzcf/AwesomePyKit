...
class Ui_pyitool(object):
    def setupUi(self, pyitool):
        ...
        self.cb_explorer_show_file = QtWidgets.QCheckBox(self.groupBox_3)
        self.cb_explorer_show_file.setObjectName("cb_explorer_show_file")
        self.verticalLayout_20.addWidget(self.cb_explorer_show_file)
        ...
        self.cb_delete_temp_dir = QtWidgets.QCheckBox(self.groupBox_3)
        self.cb_delete_temp_dir.setObjectName("cb_delete_temp_dir")
        self.verticalLayout_20.addWidget(self.cb_delete_temp_dir)
...
"\"_MEIxxxxxx\"文件夹将在您指定的位置创建，仅当您知道自己在做什么时，才使用此选项。"))
        ...
        self.groupBox_3.setTitle(_translate("pyitool", "打包完成后..."))
        self.cb_explorer_show_file.setText(_translate("pyitool", "在资源管理器中显示"))
        self.cb_delete_spec_file.setText(_translate("pyitool", "删除 SPEC 文件"))
        self.cb_delete_temp_dir.setText(_translate("pyitool", "删除临时工作文件夹"))
