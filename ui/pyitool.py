...
class Ui_pyitool(object):
    def setupUi(self, pyitool):
        ...
        self.horizontalLayout_31 = QtWidgets.QHBoxLayout(self.tab_pyitool_settings)
        ...
        self.rb_open_dir_select_file = QtWidgets.QRadioButton(self.groupBox_3)
        self.rb_open_dir_select_file.setObjectName("rb_open_dir_select_file")
        self.horizontalLayout_7.addWidget(self.rb_open_dir_select_file)
        self.rb_no_option = QtWidgets.QRadioButton(self.groupBox_3)
        self.rb_no_option.setChecked(True)
        self.rb_no_option.setObjectName("rb_no_option")
        self.horizontalLayout_7.addWidget(self.rb_no_option)
...
"\"_MEIxxxxxx\"文件夹将在您指定的位置创建，仅当您知道自己在做什么时，才使用此选项。"))
        ...
        self.rb_open_dir_select_file.setText(_translate("pyitool", "打开目录"))
        self.rb_no_option.setText(_translate("pyitool", "无操作"))
