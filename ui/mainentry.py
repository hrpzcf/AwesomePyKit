...
class Ui_mainentry(object):
    ...
    def retranslateUi(self, mainentry):
        ...
        self.pb_pkg_mgr.setToolTip(_translate("mainentry", "管理不同Python环境中的第三方模块。"))
        self.pb_pkg_mgr.setText(_translate("mainentry", "包管理器"))
        self.pb_pyi_tool.setToolTip(_translate("mainentry", "使用PYINSTALLER将py程序打包成exe可执行文件。"))
        ...
        self.pb_pkg_dload.setToolTip(_translate("mainentry", "Python包下载工具，此工具当前处于测试阶段。"))
        self.pb_pkg_dload.setText(_translate("mainentry", "模块安装包下载器"))
        self.menu_help.setTitle(_translate("mainentry", "帮助"))
