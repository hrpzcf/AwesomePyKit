...
class Ui_pkgmgr(object):
    ...
    def retranslateUi(self, pkgmgr):
        ...
        self.lw_env_list.setToolTip(_translate("pkgmgr", "使用鼠标左键点击加载选中的 Python 环境已安装的包信息列表，使用鼠标右键点击或使用上下方向键选择则不加载。"))
        ...
        self.le_search_pkgs_kwd.setPlaceholderText(_translate("pkgmgr", "搜索"))
