...
class Ui_query_panel(object):
    ...
    def retranslateUi(self, query_panel):
        query_panel.setWindowTitle(
            QCoreApplication.translate("query_panel", "\u67e5\u8be2\u9762\u677f", None)
        )
        self.uiPushButton_query.setText(
            QCoreApplication.translate("query_panel", "\u67e5\u8be2", None)
        )
        self.uiRadioButton_pkg2import.setText(
            QCoreApplication.translate(
                "query_panel", "\u4ee5\u5305\u540d\u67e5\u5bfc\u5165\u540d", None
            )
        )
        self.uiRadioButton_import2pkg.setText(
            QCoreApplication.translate(
                "query_panel", "\u4ee5\u5bfc\u5165\u540d\u67e5\u5305\u540d", None
            )
        )
        self.uiCheckBox_case_sensitive.setText(
            QCoreApplication.translate(
                "query_panel", "\u533a\u5206\u5927\u5c0f\u5199", None
            )
        )
        self.label.setText(
            QCoreApplication.translate(
                "query_panel", "\u67e5\u8be2\u73af\u5883\uff1a", None
            )
        )
        self.uiLabel_query_environ.setText(
            QCoreApplication.translate(
                "query_panel", "\u672a\u8bbe\u7f6e\u4efb\u4f55\u73af\u5883\uff01", None
            )
        )
        self.uiLabel_query_result.setText(
            QCoreApplication.translate(
                "query_panel", "\u67e5\u8be2\u7ed3\u679c\uff1a", None
            )
        )
