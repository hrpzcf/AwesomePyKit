...
class Ui_generic_output(object):
    def setupUi(self, generic_output):
        if not generic_output.objectName():
            generic_output.setObjectName(u"generic_output")
        ...
        self.uiAction_bg_white.setObjectName(u"uiAction_bg_white")
        self.uiAction_bg_black = QAction(generic_output)
        self.uiAction_bg_black.setObjectName(u"uiAction_bg_black")
        ...
        self.uiPlainTextEdit_output.setObjectName(u"uiPlainTextEdit_output")
        font1 = QFont()
        ...
        self.uiPushButton_close_window.setObjectName(u"uiPushButton_close_window")
        ...
        self.uiPushButton_clear_content.setObjectName(u"uiPushButton_clear_content")
    ...
    def retranslateUi(self, generic_output):
        generic_output.setWindowTitle(QCoreApplication.translate("generic_output", u"\u63a7\u5236\u53f0\u8f93\u51fa\u5185\u5bb9", None))
        self.action123.setText(QCoreApplication.translate("generic_output", u"\u5b57\u4f53\u989c\u8272", None))
        self.uiAction_bg_white.setText(QCoreApplication.translate("generic_output", u"\u767d\u8272", None))
        self.uiAction_bg_black.setText(QCoreApplication.translate("generic_output", u"\u9ed1\u8272", None))
        self.uiPlainTextEdit_output.setPlainText("")
        self.uiPushButton_close_window.setText(QCoreApplication.translate("generic_output", u"\u5173\u95ed\u7a97\u53e3", None))
        self.uiPushButton_clear_content.setText(QCoreApplication.translate("generic_output", u"\u6e05\u7a7a\u5185\u5bb9", None))
    # retranslateUi
