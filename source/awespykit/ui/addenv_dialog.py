...
class Ui_input_dialog(object):
    ...
    def retranslateUi(self, input_dialog):
        input_dialog.setWindowTitle(
            QCoreApplication.translate("input_dialog", "\u8f93\u5165\u5185\u5bb9", None)
        )
        # if QT_CONFIG(tooltip)
        self.uiPushButton_select_envdir.setToolTip(
            QCoreApplication.translate(
                "input_dialog",
                "\u6253\u5f00\u76ee\u5f55\u9009\u62e9\u7a97\u53e3\uff0c\u9009\u62e9 python.exe \u6587\u4ef6\u6240\u5728\u7684\u76ee\u5f55\u3002",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.uiPushButton_select_envdir.setText(
            QCoreApplication.translate("input_dialog", "\u9009\u62e9", None)
        )
        self.uiPushButton_confirm.setText(
            QCoreApplication.translate("input_dialog", "\u786e\u5b9a", None)
        )
        self.label.setText(
            QCoreApplication.translate(
                "input_dialog",
                "\u7c98\u8d34 \u201cpython.exe\u201d \u6587\u4ef6\u6240\u5728\u76ee\u5f55\u8def\u5f84\u6216\u70b9\u51fb\u201c\u9009\u62e9\u201d\u6309\u94ae\u9009\u62e9 \u201cpython.exe\u201d \u6587\u4ef6\u6240\u5728\u76ee\u5f55\u7136\u540e\u70b9\u51fb\u786e\u5b9a\u3002",
                None,
            )
        )
