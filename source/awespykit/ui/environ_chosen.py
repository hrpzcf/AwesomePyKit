...
class Ui_environ_chosen(object):
    def setupUi(self, environ_chosen):
        if not environ_chosen.objectName():
            environ_chosen.setObjectName(u"environ_chosen")
        ...
        self.uiListWidget_environ_list = QListWidget(self.centralwidget)
        self.uiListWidget_environ_list.setObjectName(u"uiListWidget_environ_list")
    ...
    def retranslateUi(self, environ_chosen):
        environ_chosen.setWindowTitle(QCoreApplication.translate("environ_chosen", u"\u9009\u62e9 Python \u73af\u5883", None))
        self.label.setText(QCoreApplication.translate("environ_chosen", u"\u9700\u8981\u5148\u5728\u5305\u7ba1\u7406\u5668\u4e2d\u6dfb\u52a0\u73af\u5883\uff0c\u8fd9\u91cc\u624d\u4f1a\u663e\u793a\u53ef\u4f9b\u9009\u62e9\u7684\u9879~", None))
    # retranslateUi
