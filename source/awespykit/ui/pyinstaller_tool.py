...
class Ui_pyinstaller_tool(object):
    def setupUi(self, pyinstaller_tool):
        ...
        pyinstaller_tool.resize(712, 762)
        font = QtGui.QFont()
        ...
        self.horizontalLayout_33.addWidget(self.uiLabel_venv_info)
        ...
        self.horizontalLayout_33.addWidget(self.uiPushButton_create_venv)
        self.horizontalLayout_33.setStretch(0, 1)
        self.gridLayout.addLayout(self.horizontalLayout_33, 1, 1, 1, 1)
        ...
        self.horizontalLayout_35.addWidget(self.splitter)
...
"选择不同 Python 环境时，在该环境中也应安装运行项目所需的所有模块。"))
        ...
        self.uiPushButton_create_venv.setText(_translate("pyinstaller_tool", "创建环境"))
