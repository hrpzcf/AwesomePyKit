...
class Ui_pyinstaller_tool(object):
    def setupUi(self, pyinstaller_tool):
        ...
        self.uiLineEdit_config_remark.setContextMenuPolicy(QtCore.Qt.CustomContextMenu)
        ...
        self.uiListWidget_saved_config.setContextMenuPolicy(QtCore.Qt.CustomContextMenu)
